...
<div id="liste">
    <ul>
        <?php foreach($requete as $row){
            ...
            <a id="pipi" onclick="document.getElementById('univ').submit();" class="nomecole"  onmouseover= "this.style.backgroundImage = 'url(<?=htmlspecialchars($row['banniere'])?>)'" onmouseout="this.style.backgroundImage = ''">
